...
<template>
  ...
  <div class="flex justify-between h-[100vh] bg-[bg-[#FAFAFA]">
    <Navbar />

    <div
      ref="scrollContainer"
      v-if="productStore.listProduct"
      class="w-[82%] max-md:w-full bg-[#FAFAFA] rounded-l-2xl shadow-[0_0_40px_rgba(0,0,0,0.05)] overflow-y-auto scrollbar-thin overscroll-y-contain"
    >
      <div
        class="sticky top-0 bg-[#FAFAFA] z-20 shadow-sm transition-all duration-300 border-0"
      >
        <div class="pt-4 px-8 bg-[#FAFAFA]">
        ...
        <div
          class="px-8 transition-all duration-500 ease-in-out bg-[#FAFAFA] mt-[10px]"
          :class="
            isTabVisible
          ...
          <div class="flex justify-between items-center gap-4 flex-wrap">
            ...
            >
              <button
                ...
                "
                class="text-[14px] px-4 py-1.5 rounded-xl font-medium transition-all duration-300 whitespace-nowrap"
        ...
        <div class="px-8 pb-2  border-b border-[#e5e5e5]">
          <div
            class="grid grid-cols-12 gap-4 px-6 py-4 bg-white rounded-xl font-semibold text-[#555] text-sm uppercase tracking-wide max-md:min-w-[800px]"
          >
            ...
            <div class="grid grid-cols-12 gap-4 p-2 items-center">
              ...
              <div class="col-span-2 flex justify-center items-center gap-3">
                <span 
                    ...
                    class="px-3 py-1 rounded-full text-[10px] font-bold uppercase border tracking-wide whitespace-nowrap bg-green-50 text-green-600 border-green-100"
                >
                    active 
                </span>
                <span 
                    v-if="productItem.status == 'hidden'"
                    class="px-3 py-1 rounded-full text-[10px] font-bold uppercase border tracking-wide whitespace-nowrap bg-red-50 text-red-600 border-red-100"
                >
                    banned 
                </span>
