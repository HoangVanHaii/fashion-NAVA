...
const isAdmin = computed(() => mockUser.role === 'admin');
const userBranchCode = computed(() => mockUser.branch_code);

const activeTab = ref(reviewStore.dashboardTab || 'stats'); 

const selectedBranch = ref(reviewStore.currentBranch || userBranchCode.value);
...
const fetchStats = async () => {
    reviewStore.currentBranch = selectedBranch.value;
    if (selectedBranch.value === 'CENTRAL' && isAdmin.value) {
        await reviewStore.getCentralProductStatsStore();
    } else {
        await reviewStore.getAllProductStatsStore(selectedBranch.value);
    }
};
    ...
    <div class="p-6 bg-gray-50 min-h-screen">
        ...
        <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 mb-6 flex items-center justify-between flex-wrap gap-4">
            <div class="flex items-center gap-4">
                ...
                <BranchSelector v-if="isAdmin" :modelValue="selectedBranch" @update:modelValue="handleBranchChange" :allowCentral="true" />
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg min-h-[500px] relative border border-gray-100">
            ...
            <div v-if="activeTab === 'stats'">
                ...
                <ProductStatsTable :stats="filteredProducts" :currentBranch="selectedBranch" />
            </div>
