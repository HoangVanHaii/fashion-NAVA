...
import { checkProductSale, formatPrice, getImage, getMainProductImage, getMaxProductPrice, getMinProductPrice } from "../utils/format";
...
onMounted(async () => {
  ...
  // Fetch similar products (category "áo" for recommendations)
  ...
  <div class="bg-[#FAFAFA] min-h-screen font-sans text-gray-900 flex flex-col">
    ...
    <main class="flex-1 pb-10">
        <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Failed Message Card -->
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-10 sm:p-6 text-center max-w-2xl mx-auto mt-10 animate-scale-up relative overflow-hidden">
                ...
                <h1 class="text-2xl sm:text-3xl font-black text-gray-900 uppercase tracking-tight mb-3">Đặt hàng thất bại!</h1>
                <p class="text-gray-500 mb-8 leading-relaxed">
                    Rất tiếc, đã có lỗi xảy ra trong quá trình xử lý đơn hàng.<br class="hidden sm:block">
                    Vui lòng kiểm tra lại thông tin thanh toán hoặc thử lại sau ít phút.
                </p>
                
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <button 
                        @click="router.push('/cart')" 
                        class="px-8 py-3 bg-black text-white font-bold rounded-lg hover:bg-gray-800 transition-all shadow-lg uppercase tracking-wide text-sm flex items-center justify-center gap-2"
                    >
                ...
                <div class="mt-8 pt-6 border-t border-gray-100">
                    <p class="text-xs text-gray-400">Cần hỗ trợ? <a href="#" class="text-blue-600 hover:underline font-bold">Liên hệ CSKH</a> ngay.</p>
                </div>
            </div>
            ...
            <div class="mt-10" v-if="products.length > 0">
                <div class="text-center mb-10">
                    <h2 class="text-2xl font-black text-gray-900 uppercase tracking-widest mb-2">Có thể bạn quan tâm</h2>
